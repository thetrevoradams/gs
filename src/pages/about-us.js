  ...
  <Layout>
    ...
    <main className="textContainer">
      ...
      <p>
        ...
        of judgments expiring annually!
      </p>
      <p css={topSpace}>
        In 2010, recognizing an opportunity to help banks and other financial institutions identify and manage their
        judgment portfolio, a team of attorneys, accountants and information professionals formed Guaranty Solutions,
        LLC. With over 70 years combined experience, we developed a unique world class judgment identification and
        management system which enables us to identify an institution’s full portfolio of judgments, including those
        held in the name of an acquired institution. Once the judgments are identified we excel in underwriting the
        debtors to determine their ability to satisfy the judgment. Armed with this information our team of highly
        skilled debt counselors work with debtors to achieve a successful satisfaction of the judgment.
      </p>
      ...
      <p style={{ fontWeight: 500 }} css={topSpace}>
        It is easy to see that we truly … <span css={orange}>Turn your write offs into revenue!</span>
      </p>
    </main>
  </Layout>
)
